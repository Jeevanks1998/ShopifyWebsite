...
<body>
            ...
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    ...
                    <div class="forms ml-auto">
                        <a href="#" class="btn"><span class="fa fa-user-circle-o"></span> <?php echo ucfirst($_COOKIE["name"]);?></a>
	...
	<section class="banner-bottom py-5">
		<div class="container py-5">
			<h3 class="title-wthree mb-lg-5 mb-4 text-center">My orders</h3>
			<?php
				$uname = $_COOKIE["name"];
				...
				if($check > 0){
					...
					while($row = mysqli_fetch_assoc($res)){
						echo "<tr>";
								echo "<td>".$slno++."</td>";
								echo "<td>".$row['uname']."<br>".$row['address']."<br>Pin - ".$row['zip']."</td>";
								echo "<td>".$row['city']."</td>";
								echo "<td>".$row['total']."</td>";
								echo "<td><form action='update.php' method='post'>
											<input type='hidden' name='total' value='".$row['total']."'>
											<input type='submit' name='submit' class='btn shop' value='update' style='padding: 6px 10px; background:orange;'>
										  </form>
									</td>";
								echo "<td><div class='ckeck_btn'>
										<form action='cancel.php' method='post'>
										<input type='hidden' name='total' value='".$row['total']."'>
										<input type='submit' name='submit' class='btn shop' value='Delete' style='padding: 6px 10px;'>
										</form>
									</div></td>";
						echo "</tr>";
					}
